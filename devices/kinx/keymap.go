...
func initKeymap() keyboard.Keymap {
	return keyboard.Keymap([]keyboard.Layer{
		...
		kinx.Layer(
			/************************************************************************************************************************************************************************************/
			/* *\                                                                                                                                                                            \* */
			/* */ KC_FN3_, KC_F1__, KC_F2__, KC_F3__, KC_F4__, KC_F5__, KC_F6__, KC_F7__, KC_F8__ /*    */, KC_F9__, KC_F10_, KC_F11_, KC_F12_, KC_PSCR, KC_SCRL, KC_PAUS, TG_(01), MO_(02), /* */
		...
		kinx.Layer(
			/************************************************************************************************************************************************************************************/
			/* *\                                                                                                                                                                            \* */
			/* */ KC_ESC_, _______, _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, _______, _______ /*    */, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, TG_(01), MO_(02), /* */
		...
		kinx.Layer(
			/************************************************************************************************************************************************************************************/
			/* *\                                                                                                                                                                            \* */
			/* */ _______, _______, _______, _______, _______, _______, _______, _______, _______ /*    */, KC_FN2_, _______, _______, _______, _______, _______, _______, _______, MO_(02), /* */
